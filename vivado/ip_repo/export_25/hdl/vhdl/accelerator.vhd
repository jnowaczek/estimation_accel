...
architecture behav of accelerator is 
    ...
    "accelerator_accelerator,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=9.359000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.659300,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=890,HLS_SYN_LUT=2752,HLS_VERSION=2022_1}";
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((not((ap_loop_dataflow_output_count = ap_bound_minus_1_output)) and (unsigned(ap_const_lv32_0) < unsigned(ap_bound_dout)) and (ap_const_logic_1 = ap_bound_empty_n) and (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_done = ap_const_logic_1))) then 
                    ap_loop_dataflow_output_count <= std_logic_vector(unsigned(ap_loop_dataflow_output_count) + unsigned(ap_const_lv32_1));
                elsif (((unsigned(ap_const_lv32_0) < unsigned(ap_bound_dout)) and (ap_loop_dataflow_output_count = ap_bound_minus_1_output) and (ap_const_logic_1 = ap_bound_empty_n) and (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_done = ap_const_logic_1))) then 
                    ap_loop_dataflow_output_count <= ap_const_lv32_0;
                end if; 
            end if;
        end if;
