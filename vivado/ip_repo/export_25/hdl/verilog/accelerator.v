...
(* CORE_GENERATION_INFO="accelerator_accelerator,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=9.359000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.659300,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=890,HLS_SYN_LUT=2752,HLS_VERSION=2022_1}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((~(ap_loop_dataflow_output_count == ap_bound_minus_1_output) & (32'd0 < ap_bound_dout) & (1'b1 == ap_bound_empty_n) & (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_continue == 1'b1) & (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_done == 1'b1))) begin
            ap_loop_dataflow_output_count <= (ap_loop_dataflow_output_count + 32'd1);
        end else if (((32'd0 < ap_bound_dout) & (ap_loop_dataflow_output_count == ap_bound_minus_1_output) & (1'b1 == ap_bound_empty_n) & (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_continue == 1'b1) & (dataflow_in_loop_VITIS_LOOP_13_1_U0_ap_done == 1'b1))) begin
            ap_loop_dataflow_output_count <= 32'd0;
        end
    end
end
