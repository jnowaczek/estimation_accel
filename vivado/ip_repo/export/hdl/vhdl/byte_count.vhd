...
architecture behav of byte_count is 
    ...
    "byte_count_byte_count,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=6.800000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.964000,HLS_SYN_LAT=658,HLS_SYN_TPT=391,HLS_SYN_MEM=82,HLS_SYN_DSP=0,HLS_SYN_FF=6143,HLS_SYN_LUT=27341,HLS_VERSION=2021_2}";
