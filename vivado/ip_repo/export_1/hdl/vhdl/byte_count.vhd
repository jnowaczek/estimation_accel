...
architecture behav of byte_count is 
    ...
    "byte_count_byte_count,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=6.800000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.964000,HLS_SYN_LAT=658,HLS_SYN_TPT=391,HLS_SYN_MEM=24,HLS_SYN_DSP=0,HLS_SYN_FF=6346,HLS_SYN_LUT=28026,HLS_VERSION=2022_1}";
...
begin
    ...
    ap_done <= count_threshold_U0_ap_done;
    ap_idle <= (split_U0_ap_idle and reduce_appearances_U0_ap_idle and (combined_appearances_t_empty_n xor ap_const_logic_1) and (appearances3_t_empty_n xor ap_const_logic_1) and (appearances2_t_empty_n xor ap_const_logic_1) and (appearances1_t_empty_n xor ap_const_logic_1) and (appearances0_t_empty_n xor ap_const_logic_1) and (input3_t_empty_n xor ap_const_logic_1) and (input2_t_empty_n xor ap_const_logic_1) and (input1_t_empty_n xor ap_const_logic_1) and (input0_t_empty_n xor ap_const_logic_1) and count_threshold_U0_ap_idle and count_appearances_U0_ap_idle and count_appearances_3_U0_ap_idle and count_appearances_2_U0_ap_idle and count_appearances_1_U0_ap_idle);
    ap_ready <= split_U0_ap_ready;
    ...
    count_threshold_U0_ap_continue <= ap_continue;
