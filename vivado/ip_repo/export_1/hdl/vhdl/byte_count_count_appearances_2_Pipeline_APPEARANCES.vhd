...
begin
    ...
    add_ln62_fu_138_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_count_01_load_1_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln66_reg_247, ap_block_pp0_stage0, count_01_fu_52, count_fu_187_p2)
    begin
    ...
    ap_sig_allocacmp_count_01_load_2_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln66_reg_247, ap_block_pp0_stage0, count_01_fu_52)
    begin
    ...
    icmp_ln62_fu_132_p2 <= "1" when (ap_sig_allocacmp_i_4 = ap_const_lv9_100) else "0";
    icmp_ln66_fu_157_p2 <= "1" when (prev_02_fu_44 = prev_4_reg_240) else "0";
    ...
    zext_ln62_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_4),64));
    zext_ln69_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_02_fu_44),64));
    zext_ln70_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_4_reg_240),64));
end behav;
