...
attribute shreg_extract : string;
    ...
    signal prev_4_reg_242 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln66_fu_136_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_count_01_load_1_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_249, ap_block_pp0_stage0, count_01_fu_50, count_fu_189_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then
            ap_sig_allocacmp_count_01_load_1 <= count_fu_189_p2;
        end if;
    end process;


    ap_sig_allocacmp_count_01_load_2_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_249, ap_block_pp0_stage0, count_01_fu_50)
    begin
        if (((icmp_ln70_reg_249 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1))) then 
            ...
            ap_sig_allocacmp_count_01_load_2 <= count_01_fu_50;
        end if; 
    end process;
    ...
    count_fu_189_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_count_01_load_2) + unsigned(ap_const_lv32_1));
    icmp_ln66_fu_130_p2 <= "1" when (ap_sig_allocacmp_i_4 = ap_const_lv9_100) else "0";
    icmp_ln70_fu_159_p2 <= "1" when (prev_4_reg_242 = prev_02_fu_42) else "0";
    ...
    trunc_ln68_fu_142_p1 <= ap_sig_allocacmp_i_4(8 - 1 downto 0);
    ...
    zext_ln74_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_4_reg_242),32));
end behav;
