...
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_done;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_idle;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_ready;
wire   [7:0] grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_input_r_address0;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_input_r_ce0;
wire   [7:0] grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_address0;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_ce0;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_we0;
wire   [31:0] grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_d0;
...
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_prev_1_out_ap_vld;
wire   [31:0] grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_count_out;
wire    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_count_out_ap_vld;
reg    grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 131'd1;
#0 grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg = 1'b0;
end

byte_count_count_appearances_3_Pipeline_APPEARANCES grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start),
    .ap_done(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_done),
    .ap_idle(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_idle),
    .ap_ready(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_ready),
    .prev(input_r_q0),
    .input_r_address0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_input_r_address0),
    .input_r_ce0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_input_r_ce0),
    .input_r_q0(input_r_q0),
    .appearances_address0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_address0),
    .appearances_ce0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_ce0),
    .appearances_we0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_we0),
    .appearances_d0(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_d0),
    .appearances_address1(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_address1),
    .appearances_ce1(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_appearances_ce1),
    .appearances_q1(appearances_q1),
    .prev_1_out(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_prev_1_out),
    .prev_1_out_ap_vld(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_prev_1_out_ap_vld),
    .count_out(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_count_out),
    .count_out_ap_vld(grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_count_out_ap_vld)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state129)) begin
            grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg <= 1'b1;
        end else if ((grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_ready == 1'b1)) begin
            grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state131)) begin
        appearances_d0 = grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_count_out;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state130 : begin
            if (((1'b1 == ap_CS_fsm_state130) & (grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_done == 1'b1))) begin
...
assign grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start = grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_ap_start_reg;

assign zext_ln79_fu_2885_p1 = grp_count_appearances_3_Pipeline_APPEARANCES_fu_2867_prev_1_out;
