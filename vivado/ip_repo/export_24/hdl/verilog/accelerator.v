...
module accelerator (
        s_axi_num_blocks_AWVALID,
        s_axi_num_blocks_AWREADY,
        s_axi_num_blocks_AWADDR,
        s_axi_num_blocks_WVALID,
        s_axi_num_blocks_WREADY,
        s_axi_num_blocks_WDATA,
        s_axi_num_blocks_WSTRB,
        s_axi_num_blocks_ARVALID,
        s_axi_num_blocks_ARREADY,
        s_axi_num_blocks_ARADDR,
        s_axi_num_blocks_RVALID,
        s_axi_num_blocks_RREADY,
        s_axi_num_blocks_RDATA,
        s_axi_num_blocks_RRESP,
        s_axi_num_blocks_BVALID,
        s_axi_num_blocks_BREADY,
        s_axi_num_blocks_BRESP,
        ap_clk,
        ap_rst_n,
        In_r_TDATA,
        Out_r_TDATA,
...
parameter    C_S_AXI_NUM_BLOCKS_DATA_WIDTH = 32;
parameter    C_S_AXI_NUM_BLOCKS_ADDR_WIDTH = 5;
parameter    C_S_AXI_DATA_WIDTH = 32;

parameter C_S_AXI_NUM_BLOCKS_WSTRB_WIDTH = (32 / 8);
parameter C_S_AXI_WSTRB_WIDTH = (32 / 8);

input   s_axi_num_blocks_AWVALID;
output   s_axi_num_blocks_AWREADY;
input  [C_S_AXI_NUM_BLOCKS_ADDR_WIDTH - 1:0] s_axi_num_blocks_AWADDR;
input   s_axi_num_blocks_WVALID;
output   s_axi_num_blocks_WREADY;
input  [C_S_AXI_NUM_BLOCKS_DATA_WIDTH - 1:0] s_axi_num_blocks_WDATA;
input  [C_S_AXI_NUM_BLOCKS_WSTRB_WIDTH - 1:0] s_axi_num_blocks_WSTRB;
input   s_axi_num_blocks_ARVALID;
output   s_axi_num_blocks_ARREADY;
input  [C_S_AXI_NUM_BLOCKS_ADDR_WIDTH - 1:0] s_axi_num_blocks_ARADDR;
output   s_axi_num_blocks_RVALID;
input   s_axi_num_blocks_RREADY;
output  [C_S_AXI_NUM_BLOCKS_DATA_WIDTH - 1:0] s_axi_num_blocks_RDATA;
output  [1:0] s_axi_num_blocks_RRESP;
output   s_axi_num_blocks_BVALID;
input   s_axi_num_blocks_BREADY;
output  [1:0] s_axi_num_blocks_BRESP;
input   ap_clk;
input   ap_rst_n;
