...
module accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 3,
    AddressRange = 32,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
