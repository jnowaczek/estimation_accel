...
// 0x20 : Control signal of output_r
...
#define XBYTE_COUNT_CONTROL_ADDR_OUTPUT_R_DATA 0x1c
#define XBYTE_COUNT_CONTROL_BITS_OUTPUT_R_DATA 32
#define XBYTE_COUNT_CONTROL_ADDR_OUTPUT_R_CTRL 0x20
