...
attribute shreg_extract : string;
    ...
    signal gmem_addr_read_reg_312 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_phi_mux_empty_19_phi_fu_152_p4 : STD_LOGIC_VECTOR (255 downto 0);
    signal ap_phi_reg_pp0_iter2_empty_19_reg_149 : STD_LOGIC_VECTOR (255 downto 0);
    signal shiftreg_cast_fu_215_p1 : STD_LOGIC_VECTOR (255 downto 0);
    signal zext_ln48_fu_235_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal shiftreg_fu_78 : STD_LOGIC_VECTOR (223 downto 0);
    ...
    signal empty_20_fu_187_p1 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    shiftreg_fu_78 <= ap_const_lv224_lc_1;
                elsif ((ap_enable_reg_pp0_iter2 = ap_const_logic_1)) then 
                    shiftreg_fu_78 <= ap_phi_mux_empty_19_phi_fu_152_p4(255 downto 32);
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_phi_reg_pp0_iter2_empty_19_reg_149 <= "";
    ...
    empty_20_fu_187_p1 <= ap_sig_allocacmp_i_1(3 - 1 downto 0);
    ...
    icmp_ln47_fu_191_p2 <= "1" when (empty_20_fu_187_p1 = ap_const_lv3_0) else "0";
    ...
    shiftreg_cast_fu_215_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shiftreg_fu_78),256));
