...
begin
    ...
    add_ln66_fu_138_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_count_01_load_3_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_247, ap_block_pp0_stage0, count_01_fu_52, count_fu_187_p2)
    begin
    ...
    ap_sig_allocacmp_count_01_load_4_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_247, ap_block_pp0_stage0, count_01_fu_52)
    begin
    ...
    icmp_ln66_fu_132_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv9_100) else "0";
    icmp_ln70_fu_157_p2 <= "1" when (prev_5_reg_240 = prev_02_fu_44) else "0";
    ...
    zext_ln66_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_5),64));
    zext_ln73_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_02_fu_44),64));
    zext_ln74_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_5_reg_240),64));
end behav;
