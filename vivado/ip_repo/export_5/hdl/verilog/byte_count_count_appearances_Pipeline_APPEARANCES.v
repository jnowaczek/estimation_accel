...
reg   [31:0] count_1_fu_52;
wire   [31:0] count_fu_187_p2;
reg   [31:0] ap_sig_allocacmp_count_1_load_1;
reg   [31:0] ap_sig_allocacmp_count_1_load_2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        ...
        ap_sig_allocacmp_count_1_load_1 = count_1_fu_52;
    end
end
...
assign add_ln66_fu_138_p2 = (ap_sig_allocacmp_i_2 + 9'd1);
...
assign appearances_d0 = ap_sig_allocacmp_count_1_load_1;

assign count_01_out = count_1_fu_52;

assign count_fu_187_p2 = (ap_sig_allocacmp_count_1_load_2 + 32'd1);

assign icmp_ln66_fu_132_p2 = ((ap_sig_allocacmp_i_2 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln70_fu_157_p2 = ((prev_2_reg_240 == prev_1_fu_44) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln66_fu_144_p1;

assign prev_02_out = prev_1_fu_44;

assign zext_ln66_fu_144_p1 = ap_sig_allocacmp_i_2;

assign zext_ln73_fu_166_p1 = prev_1_fu_44;

assign zext_ln74_fu_171_p1 = prev_2_reg_240;
