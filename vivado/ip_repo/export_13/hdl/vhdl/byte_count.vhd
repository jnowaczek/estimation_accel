...
architecture behav of byte_count is 
    ...
    "byte_count_byte_count,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=1158,HLS_SYN_TPT=1159,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=2272,HLS_SYN_LUT=11665,HLS_VERSION=2022_1}";
    ...
    signal count_appearances_U0_m_axi_gmem_AWADDR : STD_LOGIC_VECTOR (31 downto 0);
