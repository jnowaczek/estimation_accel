...
begin
    ...
    add_ln66_fu_138_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_count_load_1_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_247, ap_block_pp0_stage0, count_fu_52, count_2_fu_187_p2)
    begin
    ...
    ap_sig_allocacmp_count_load_2_assign_proc : process(ap_enable_reg_pp0_iter3, appearances_q1, icmp_ln70_reg_247, ap_block_pp0_stage0, count_fu_52)
    begin
    ...
    count_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln66_reg_231_pp0_iter1_reg)
    begin
    ...
    icmp_ln66_fu_132_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv9_100) else "0";
    icmp_ln70_fu_157_p2 <= "1" when (prev_3_reg_240 = prev_1_fu_44) else "0";
    ...
    prev_1_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln66_reg_231_pp0_iter1_reg)
    begin
        if (((icmp_ln66_reg_231_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    zext_ln66_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_3),64));
    zext_ln73_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_1_fu_44),64));
    zext_ln74_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_3_reg_240),64));
end behav;
