...
namespace eval ::optrace {
  variable script "E:/estimation_accel/vivado/zc702_dma_loopback_platform/zc702_dma_loopback_platform.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  ...
  update_ip_catalog
  set_property ip_output_repo E:/estimation_accel/vivado/zc702_dma_loopback_platform/zc702_dma_loopback_platform.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/estimation_accel/vivado/zc702_dma_loopback_platform/zc702_dma_loopback_platform.runs/synth_1/system_wrapper.dcp
