...
#
# Generated by export_simulation on Sun Oct 02 12:20:16 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './concat_intr.sh' script.

./concat_intr.sh -reset_run
...
./concat_intr.sh -noclean_files

For more information on the script, please type './concat_intr.sh -help'.
