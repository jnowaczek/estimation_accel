...
LD_LIBRARY_PATH=.:C:/Xilinx/Vivado/2022.1/data/xsim/ip/remote_port_c_v4:C:/Xilinx/Vivado/2022.1/data/xsim/ip/common_cpp_v1_0:C:/Xilinx/Vivado/2022.1/data/xsim/ip/xtlm:$LD_LIBRARY_PATH

export xv_cpt_lib_path="C:/Xilinx/Vivado/2022.1/data/simmodels/questa/2021.3/win64/6.2.0/systemc/protected"
...
elaborate()
{
  sccom -cpppath "/g++" -link -LC:/Xilinx/Vivado/2022.1/data/xsim/ip/remote_port_c_v4 -lremote_port_c_v4 -LC:/Xilinx/Vivado/2022.1/data/xsim/ip/common_cpp_v1_0 -lcommon_cpp_v1_0 -lib xtlm -work xil_defaultlib 2>&1 | tee elaborate.log
...
simulate()
{
  vsim  -cpppath "/g++" -c -do "do {simulate.do}" -l simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/estimation_accel/vivado/zc702_estimation_platform.cache/compile_simlib/questa"
  fi
