...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    example_hls_deadlock_detect_unit #(3, 0, 2, 2) example_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.outTop_c_blk_n);
    ...
    example_hls_deadlock_detect_unit #(3, 1, 2, 2) example_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~getinstream_U0.buf_r_blk_n) | (~getinstream_U0.count9_blk_n);
    ...
    example_hls_deadlock_detect_unit #(3, 2, 2, 2) example_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105.buf_r_blk_n) | (~streamtoparallelwithburst_U0.count9_blk_n);
...
`include "example_hls_deadlock_report_unit.vh"
