...
module byte_count_count_appearances_2_Pipeline_APPEARANCES (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] prev_02_fu_42;
wire    ap_loop_init;
reg   [8:0] i_fu_46;
wire   [8:0] add_ln66_fu_136_p2;
reg   [8:0] ap_sig_allocacmp_i_4;
reg   [31:0] count_01_fu_50;
wire   [31:0] count_fu_189_p2;
reg   [31:0] ap_sig_allocacmp_count_01_load_1;
reg   [31:0] ap_sig_allocacmp_count_01_load_2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        ...
        ap_sig_allocacmp_count_01_load_1 = count_01_fu_50;
    end
end
...
assign add_ln66_fu_136_p2 = (ap_sig_allocacmp_i_4 + 9'd1);
...
assign appearances_d0 = ap_sig_allocacmp_count_01_load_1;

assign count_01_out = count_01_fu_50;

assign count_fu_189_p2 = (ap_sig_allocacmp_count_01_load_2 + 32'd1);

assign icmp_ln66_fu_130_p2 = ((ap_sig_allocacmp_i_4 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln70_fu_159_p2 = ((prev_4_reg_242 == prev_02_fu_42) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln68_fu_146_p1;

assign prev_02_out = prev_02_fu_42;

assign trunc_ln68_fu_142_p1 = ap_sig_allocacmp_i_4[7:0];

assign zext_ln68_fu_146_p1 = trunc_ln68_fu_142_p1;

assign zext_ln73_fu_168_p1 = prev_02_fu_42;

assign zext_ln74_fu_173_p1 = prev_4_reg_242;

endmodule //byte_count_count_appearances_2_Pipeline_APPEARANCES
