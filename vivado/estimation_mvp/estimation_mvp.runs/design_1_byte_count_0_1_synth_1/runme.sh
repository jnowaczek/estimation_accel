...
HD_PWD='E:/estimation_accel/vivado/estimation_mvp/estimation_mvp.runs/design_1_byte_count_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_byte_count_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_byte_count_0_1.tcl
