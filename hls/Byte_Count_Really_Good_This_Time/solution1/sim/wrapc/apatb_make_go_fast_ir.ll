...
define void @apatb_make_go_fast_ir(%"struct.ap_uint<8>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %in, %"struct.ap_uint<8>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %out) local_unnamed_addr #0 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([64 x %"struct.ap_uint<8>"]* noalias "unpacked"="0", [64 x i8]* noalias nocapture readonly align 512 "unpacked"="1.0", [64 x %"struct.ap_uint<8>"]* noalias "unpacked"="2", [64 x i8]* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a64struct.ap_uint<8>"([64 x %"struct.ap_uint<8>"]* noalias "unpacked"="0" %dst, [64 x i8]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64struct.ap_uint<8>.13"([64 x %"struct.ap_uint<8>"]* "unpacked"="0" %dst, [64 x i8]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [64 x %"struct.ap_uint<8>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a64struct.ap_uint<8>.17"([64 x i8]* noalias nocapture align 512 "unpacked"="0.0" %dst, [64 x %"struct.ap_uint<8>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a64struct.ap_uint<8>.20"([64 x i8]* nocapture "unpacked"="0.0" %dst, [64 x %"struct.ap_uint<8>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #4 {
entry:
  %0 = icmp eq [64 x %"struct.ap_uint<8>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([64 x %"struct.ap_uint<8>"]* noalias "unpacked"="0", [64 x i8]* noalias nocapture readonly align 512 "unpacked"="1.0", [64 x %"struct.ap_uint<8>"]* noalias "unpacked"="2", [64 x i8]* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a64struct.ap_uint<8>"([64 x %"struct.ap_uint<8>"]* %2, [64 x i8]* align 512 %3)
  ret void
}
