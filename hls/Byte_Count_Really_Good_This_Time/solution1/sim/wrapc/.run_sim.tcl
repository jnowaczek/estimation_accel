...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "make_go_fast.autotvin.dat"
	set constFileTvOut       "make_go_fast.autotvout.dat"
	set constFileHdlTvIn     "make_go_fast.autohdltvin.dat"
	set constFileHdlTvOut    "make_go_fast.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
