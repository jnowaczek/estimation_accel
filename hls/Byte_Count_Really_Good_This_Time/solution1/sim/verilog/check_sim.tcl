...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.make_go_fast.autotvin_in_r_V_data_V.dat"
         "c.make_go_fast.autotvin_in_r_V_keep_V.dat"
         "c.make_go_fast.autotvin_in_r_V_strb_V.dat"
         "c.make_go_fast.autotvin_in_r_V_last_V.dat"
         "c.make_go_fast.autotvin_n.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.make_go_fast.autotvout_out_r_V_data_V.dat"
         "rtl.make_go_fast.autotvout_out_r_V_keep_V.dat"
         "rtl.make_go_fast.autotvout_out_r_V_strb_V.dat"
         "rtl.make_go_fast.autotvout_out_r_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
