...
if {[file isfile make_go_fast.autotvin.dat]} {
	file delete -force make_go_fast.autotvin.dat
}

if {[file isfile make_go_fast.autotvout.dat]} {
	file delete -force make_go_fast.autotvout.dat
}
