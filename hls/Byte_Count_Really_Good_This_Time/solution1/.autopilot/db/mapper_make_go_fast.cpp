...
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
extern "C" void make_go_fast(volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , );
...
auto* sInStream_V_data_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_InStream_V_data_V);
auto* sInStream_V_keep_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_InStream_V_keep_V);
auto* sInStream_V_strb_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_InStream_V_strb_V);
auto* sInStream_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_InStream_V_last_V);
...
auto* sOutStream_V_data_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OutStream_V_data_V);
...
auto* sOutStream_V_keep_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OutStream_V_keep_V);
...
auto* sOutStream_V_strb_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OutStream_V_strb_V);
...
auto* sOutStream_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OutStream_V_last_V);
  // DUT call
  make_go_fast(sInStream_V_data_V->data<char>(), sInStream_V_keep_V->data<char>(), sInStream_V_strb_V->data<char>(), sInStream_V_last_V->data<char>(), sOutStream_V_data_V->data<char>(), sOutStream_V_keep_V->data<char>(), sOutStream_V_strb_V->data<char>(), sOutStream_V_last_V->data<char>());
sInStream_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_InStream_V_data_V);
...
s->transfer((hls::stream<char>*)__xlx_apatb_param_);
s->transfer((hls::stream<char>*)__xlx_apatb_param_);
sOutStream_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_OutStream_V_data_V);
