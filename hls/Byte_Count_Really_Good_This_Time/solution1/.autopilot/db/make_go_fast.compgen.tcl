...
# FIFO definition: 
set ID 22
set FifoName make_go_fast_fifo_w9_d256_A
set InstName split_buffer_U
...
# FIFO definition: 
set ID 23
set FifoName make_go_fast_start_for_process_split_stream_U0
set InstName start_for_process_split_stream_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 24 \
			corename make_go_fast_control_axilite \
			name make_go_fast_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler make_go_fast_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { InStream_TLAST { I 1 vector } InStream_TVALID { I 1 bit } InStream_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { OutStream_TLAST { O 1 vector } OutStream_TVALID { O 1 bit } OutStream_TREADY { I 1 bit } } \
} "
} else {
