set moduleName count_appearances_Pipeline_VITIS_LOOP_31_1
set isTopModule 0
...
set C_modelName {count_appearances_Pipeline_VITIS_LOOP_31_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ appearances int 16 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "appearances", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ appearances_we0 sc_out sc_logic 1 signal 0 } 
	{ appearances_d0 sc_out sc_lv 16 signal 0 } 
...
set Spec2ImplPortList { 
	appearances { mem_fifo {  { appearances_address0 mem_address 1 8 }  { appearances_ce0 mem_ce 1 1 }  { appearances_we0 mem_we 1 1 }  { appearances_d0 mem_din 1 16 } } }
}
