...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_split_in \
    op interface \
    ports { split_in_din { O 8 vector } split_in_full_n { I 1 bit } split_in_write { O 1 bit } } \
} "
}
...
set InstName make_go_fast_flow_control_loop_pipe_U
set CompName make_go_fast_flow_control_loop_pipe
