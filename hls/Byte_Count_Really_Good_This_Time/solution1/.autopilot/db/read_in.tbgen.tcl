...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set portList { 
	...
	{ m_axi_gmem_RFIFONUM sc_in sc_lv 13 signal 0 } 
	...
	{ split_in_din sc_out sc_lv 8 signal 2 } 
	{ split_in_full_n sc_in sc_logic 1 signal 2 } 
	{ split_in_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "gmem", "role": "RFIFONUM" }} , 
...
set ArgLastReadFirstWriteLatency {
	read_in {
		...
		split_in {Type O LastRead -1 FirstWrite 10}}}
