...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_merge_out \
    op interface \
    ports { merge_out_dout { I 8 vector } merge_out_empty_n { I 1 bit } merge_out_read { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 49
set RegSliceName make_go_fast_regslice_both
set RegSliceInstName make_go_fast_regslice_both_U
set CoreName ap_simcore_make_go_fast_regslice_both
