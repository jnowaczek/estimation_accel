...
# 3 "Byte_Count_Really_Good_This_Time/accelerator.cpp" 2
...
void split_input_stream(hls::stream<input_pkt> &input_stream,
 ...
 VITIS_LOOP_16_1: do {
  VITIS_LOOP_17_2: for (int i = 0; i < 1; i++) {
...
__attribute__((sdx_kernel("make_go_fast", 0))) void make_go_fast(hls::stream<input_pkt> &InStream,
  hls::stream<output_pkt> &OutStream) {
#line 13 "E:/estimation_accel/hls/Byte_Count_Really_Good_This_Time/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=make_go_fast
# 35 "Byte_Count_Really_Good_This_Time/accelerator.cpp"
