# 1 "Byte_Count_Really_Good_This_Time/accelerator.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Byte_Count_Really_Good_This_Time/accelerator.cpp" 2
# 1 "Byte_Count_Really_Good_This_Time/accelerator.h" 1
...
# 39 "C:/Xilinx/Vitis_HLS/2023.1/tps/mingw/8.3.0/win64.o/nt\\lib\\gcc\\x86_64-w64-mingw32\\8.3.0\\include\\c++\\cstdint" 2 3
...
# 4 "Byte_Count_Really_Good_This_Time/accelerator.h" 2
...
# 6 "Byte_Count_Really_Good_This_Time/accelerator.h" 2
...
# 196 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\ap_axi_sdata.h" 2
namespace hls {
...
# 7 "Byte_Count_Really_Good_This_Time/accelerator.h" 2
# 1 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\hls_np_channel.h" 1
...
public:
  ...
  __attribute__((nodebug)) load_balance(const char *name = nullptr) {
#pragma HLS inline
 (void) name;
...
public:
  stream<T> in __attribute__((no_ctor));
  stream<T> out[N_OUT_PORTS] __attribute__((no_ctor));
  __attribute__((nodebug)) round_robin(const char *name = nullptr) {
#pragma HLS inline
 (void) name;
...
# 8 "Byte_Count_Really_Good_This_Time/accelerator.h" 2

# 1 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\hls_streamofblocks.h" 1
# 26 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\hls_streamofblocks.h"
namespace hls {
template <typename __STREAM_T__>
class stream_buf {
...
# 71 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\hls_streamofblocks.h"
  template <typename>
...
# 142 "C:/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot\\hls_streamofblocks.h"
template <typename __STREAM_T__>
class read_lock {
...
# 10 "Byte_Count_Really_Good_This_Time/accelerator.h" 2
# 19 "Byte_Count_Really_Good_This_Time/accelerator.h"
...
__attribute__((sdx_kernel("make_go_fast", 0))) void make_go_fast(hls::stream<data_pkt> &in, hls::stream<result_t> &out);
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_22_1: for (int i = 0; i < 1024; i++) {
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_44_1: for (int i = 0; i < 256; i++) {
  if (inL[i] > 1024 / 256) {
   over_thresh += 1;
  }
 }
...
# 66 "Byte_Count_Really_Good_This_Time/accelerator.cpp"
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_71_1: for (int i = 0; i < 256; i++) {
  outL[i] = inL0[i];
 }
}

__attribute__((sdx_kernel("make_go_fast", 0))) void make_go_fast(hls::stream<data_pkt> &in, hls::stream<result_t> &out) {
#line 19 "E:/estimation_accel/hls/Byte_Count_Really_Good_This_Time/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=make_go_fast
# 76 "Byte_Count_Really_Good_This_Time/accelerator.cpp"
