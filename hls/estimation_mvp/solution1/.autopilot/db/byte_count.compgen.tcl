...
set ID 12
set hasByteEnable 0
set MemName byte_count_appearances_RAM_AUTO_1R1W_memcore
...
set MemName byte_count_appearances_RAM_AUTO_1R1W
...
set name byte_count_gmem_m_axi
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 13 \
			corename byte_count_control_axilite \
			name byte_count_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler byte_count_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
