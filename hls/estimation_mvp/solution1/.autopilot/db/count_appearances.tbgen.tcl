...
set C_modelArgList {
	...
	{ appearances int 32 regular {array 256 { 0 2 } 1 1 }  }
}
...
set portList { 
	...
	{ appearances_address0 sc_out sc_lv 8 signal 2 } 
	{ appearances_ce0 sc_out sc_logic 1 signal 2 } 
	{ appearances_we0 sc_out sc_logic 1 signal 2 } 
	{ appearances_d0 sc_out sc_lv 32 signal 2 } 
	{ appearances_address1 sc_out sc_lv 8 signal 2 } 
	{ appearances_ce1 sc_out sc_logic 1 signal 2 } 
	{ appearances_we1 sc_out sc_logic 1 signal 2 } 
	{ appearances_d1 sc_out sc_lv 32 signal 2 } 
	{ appearances_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "appearances_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "appearances", "role": "we1" }} , 
 	{ "name": "appearances_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "appearances", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_count_appearances_Pipeline_APPEARANCES_fu_2893", "Port" : "gmem", "Inst_start_state" : "129", "Inst_end_state" : "130"}]},
			{"Name" : "input_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "appearances", "Type" : "Memory", "Direction" : "IO", "DependentProc" : ["0"], "DependentChan" : "0", "PIPODir" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_count_appearances_Pipeline_APPEARANCES_fu_2893", "Port" : "appearances", "Inst_start_state" : "129", "Inst_end_state" : "130"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_count_appearances_Pipeline_APPEARANCES_fu_2893", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_count_appearances_Pipeline_APPEARANCES_fu_2893.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	appearances { ap_memory {  { appearances_address0 mem_address 1 8 }  { appearances_ce0 mem_ce 1 1 }  { appearances_we0 mem_we 1 1 }  { appearances_d0 mem_din 1 32 }  { appearances_address1 MemPortADDR2 1 8 }  { appearances_ce1 MemPortCE2 1 1 }  { appearances_we1 MemPortWE2 1 1 }  { appearances_d1 MemPortDIN2 1 32 }  { appearances_q1 MemPortDOUT2 0 32 } } }
}
