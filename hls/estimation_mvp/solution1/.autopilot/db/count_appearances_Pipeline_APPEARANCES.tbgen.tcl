set moduleName count_appearances_Pipeline_APPEARANCES
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {count_appearances_Pipeline_APPEARANCES}
set C_modelType { void 0 }
set C_modelArgList {
	{ prev int 8 regular  }
	{ gmem int 8 regular {axi_master 0}  }
	{ input_r int 32 regular  }
	{ appearances int 32 regular {array 256 { 0 1 } 1 1 }  }
	{ prev_1_out int 8 regular {pointer 1}  }
	{ count_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "prev", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "appearances", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "prev_1_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem_AWADDR sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_gmem_ARADDR sc_out sc_lv 32 signal 1 } 
	...
	{ prev sc_in sc_lv 8 signal 0 } 
	{ input_r sc_in sc_lv 32 signal 2 } 
	{ appearances_address0 sc_out sc_lv 8 signal 3 } 
	{ appearances_ce0 sc_out sc_logic 1 signal 3 } 
	{ appearances_we0 sc_out sc_logic 1 signal 3 } 
	{ appearances_d0 sc_out sc_lv 32 signal 3 } 
	{ appearances_address1 sc_out sc_lv 8 signal 3 } 
	{ appearances_ce1 sc_out sc_logic 1 signal 3 } 
	{ appearances_q1 sc_in sc_lv 32 signal 3 } 
	{ prev_1_out sc_out sc_lv 8 signal 4 } 
	{ prev_1_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ count_out sc_out sc_lv 32 signal 5 } 
	{ count_out_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "prev", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "prev", "role": "default" }} , 
 	...
 	{ "name": "appearances_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "appearances", "role": "d0" }} , 
 	...
 	{ "name": "prev_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "prev_1_out", "role": "default" }} , 
 	{ "name": "prev_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "prev_1_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	appearances { ap_memory {  { appearances_address0 mem_address 1 8 }  { appearances_ce0 mem_ce 1 1 }  { appearances_we0 mem_we 1 1 }  { appearances_d0 mem_din 1 32 }  { appearances_address1 MemPortADDR2 1 8 }  { appearances_ce1 MemPortCE2 1 1 }  { appearances_q1 in_data 0 32 } } }
	prev_1_out { ap_vld {  { prev_1_out out_data 1 8 }  { prev_1_out_ap_vld out_vld 1 1 } } }
