...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename appearances \
    op interface \
    ports { appearances_address0 { O 8 vector } appearances_ce0 { O 1 bit } appearances_we0 { O 1 bit } appearances_d0 { O 32 vector } appearances_address1 { O 8 vector } appearances_ce1 { O 1 bit } appearances_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'appearances'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_prev_1_out \
    op interface \
    ports { prev_1_out { O 8 vector } prev_1_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName byte_count_flow_control_loop_pipe_sequential_init_U
set CompName byte_count_flow_control_loop_pipe_sequential_init
