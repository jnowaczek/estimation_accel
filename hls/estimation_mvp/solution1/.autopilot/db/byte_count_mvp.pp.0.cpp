...
# 2 "<built-in>" 2
# 1 "byte_count_mvp.cpp" 2
# 1 "./byte_count_mvp.hpp" 1
...
# 10 "./byte_count_mvp.hpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_int.h" 1
# 11 "./byte_count_mvp.hpp" 2
# 27 "./byte_count_mvp.hpp"
...
void count_appearances(data_t *input, count_t appearances[256]);

void count_threshold(count_t appearances[256], result_t &output);

__attribute__((sdx_kernel("byte_count", 0))) void byte_count(data_t input[1024], result_t &output);
# 2 "byte_count_mvp.cpp" 2

__attribute__((sdx_kernel("byte_count", 0))) void byte_count(data_t *input, result_t &output) {
#line 19 "E:/estimation_accel/hls/estimation_mvp/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=byte_count
# 3 "byte_count_mvp.cpp"

#line 6 "E:/estimation_accel/hls/estimation_mvp/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=byte_count
# 3 "byte_count_mvp.cpp"
