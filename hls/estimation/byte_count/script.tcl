...
set_top byte_count
add_files ../shared/byte_count_gold/byte_count_types.hpp
...
add_files -tb ../shared/byte_count_gold/byte_count_gold.hpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
