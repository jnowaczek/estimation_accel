<project xmlns="com.autoesl.autopilot.project" top="example" name="axi_stream_to_master_example">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="example.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
