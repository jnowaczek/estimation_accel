...
wire   [31:0] count_2_fu_105_p2;
reg   [31:0] count_2_reg_154;
wire   [0:0] or_ln44_fu_127_p2;
reg   [31:0] count_fu_50;
reg   [31:0] ap_sig_allocacmp_count_1;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_01001;
wire   [25:0] tmp_fu_111_p4;
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (or_ln44_reg_160 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        count_fu_50 <= 32'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln44_reg_160 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_last_V_fu_92_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (or_ln44_reg_160 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1)))) begin
        ap_sig_allocacmp_count_1 = 32'd0;
    end else if (((1'b0 == ap_block_pp0_stage0) & (or_ln44_reg_160 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (or_ln44_reg_160 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (or_ln44_reg_160 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        count9_write = 1'b1;
    end else begin
        count9_write = 1'b0;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((or_ln44_reg_160 == 1'd1) & (count9_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | (buf_r_full_n == 1'b0) | (inStreamTop_TVALID_int_regslice == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((or_ln44_reg_160 == 1'd1) & (count9_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | (buf_r_full_n == 1'b0) | (inStreamTop_TVALID_int_regslice == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((or_ln44_reg_160 == 1'd1) & (count9_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | (buf_r_full_n == 1'b0) | (inStreamTop_TVALID_int_regslice == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((or_ln44_reg_160 == 1'd1) & (count9_full_n == 1'b0));
end
...
assign buf_r_din = {{inStreamTop_TLAST_int_regslice}, {inStreamTop_TDATA_int_regslice}};

assign count9_din = count_2_reg_154;

assign count_2_fu_105_p2 = (ap_sig_allocacmp_count_1 + 32'd1);

assign icmp_ln44_fu_121_p2 = (($signed(tmp_fu_111_p4) > $signed(26'd0)) ? 1'b1 : 1'b0);

assign inStreamTop_TREADY = regslice_both_inStreamTop_V_data_V_U_ack_in;

assign or_ln44_fu_127_p2 = (inStreamTop_TLAST_int_regslice | icmp_ln44_fu_121_p2);

assign tmp_fu_111_p4 = {{count_2_fu_105_p2[31:6]}};

assign tmp_last_V_fu_92_p1 = inStreamTop_TLAST_int_regslice;
