...
attribute shreg_extract : string;
    ...
    signal or_ln44_reg_160 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal count_2_fu_105_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal count_2_reg_154 : STD_LOGIC_VECTOR (31 downto 0);
    signal or_ln44_fu_127_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal count_fu_50 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_count_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_fu_111_p4 : STD_LOGIC_VECTOR (25 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln44_reg_160 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
                count_fu_50 <= ap_const_lv32_0;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln44_reg_160 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                count_fu_50 <= count_2_reg_154;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                count_2_reg_154 <= count_2_fu_105_p2;
                or_ln44_reg_160 <= or_ln44_fu_127_p2;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, buf_r_full_n, ap_done_reg, count9_full_n, or_ln44_reg_160, ap_start_int, inStreamTop_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((or_ln44_reg_160 = ap_const_lv1_1) and (count9_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or (buf_r_full_n = ap_const_logic_0) or (inStreamTop_TVALID_int_regslice = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, buf_r_full_n, ap_done_reg, count9_full_n, or_ln44_reg_160, ap_start_int, inStreamTop_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((or_ln44_reg_160 = ap_const_lv1_1) and (count9_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or (buf_r_full_n = ap_const_logic_0) or (inStreamTop_TVALID_int_regslice = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, buf_r_full_n, ap_done_reg, count9_full_n, or_ln44_reg_160, ap_start_int, inStreamTop_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((or_ln44_reg_160 = ap_const_lv1_1) and (count9_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or (buf_r_full_n = ap_const_logic_0) or (inStreamTop_TVALID_int_regslice = ap_const_logic_0))));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(count9_full_n, or_ln44_reg_160)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((or_ln44_reg_160 = ap_const_lv1_1) and (count9_full_n = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, tmp_last_V_fu_92_p1, ap_start_int)
    begin
        if (((tmp_last_V_fu_92_p1 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_count_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, or_ln44_reg_160, ap_block_pp0_stage0, count_2_reg_154, count_fu_50, ap_loop_init, ap_start_int)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0) and (or_ln44_reg_160 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
            ap_sig_allocacmp_count_1 <= ap_const_lv32_0;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (or_ln44_reg_160 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_count_1 <= count_2_reg_154;
        else 
    ...
    buf_r_din <= (inStreamTop_TLAST_int_regslice & inStreamTop_TDATA_int_regslice);
    ...
    count9_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, count9_full_n, or_ln44_reg_160, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (or_ln44_reg_160 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            count9_blk_n <= count9_full_n;
        else 
            count9_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    count9_din <= count_2_reg_154;

    count9_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, or_ln44_reg_160, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (or_ln44_reg_160 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            count9_write <= ap_const_logic_1;
        else 
            count9_write <= ap_const_logic_0;
        end if; 
    end process;

    count_2_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_count_1) + unsigned(ap_const_lv32_1));
    icmp_ln44_fu_121_p2 <= "1" when (signed(tmp_fu_111_p4) > signed(ap_const_lv26_0)) else "0";
    ...
    or_ln44_fu_127_p2 <= (inStreamTop_TLAST_int_regslice or icmp_ln44_fu_121_p2);
    tmp_fu_111_p4 <= count_2_fu_105_p2(31 downto 6);
    tmp_last_V_fu_92_p1 <= inStreamTop_TLAST_int_regslice;
end behav;
