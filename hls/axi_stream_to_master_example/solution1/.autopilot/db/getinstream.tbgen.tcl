...
set C_modelArgList {
	...
	{ buf_r int 65 regular {fifo 1 volatile }  }
	{ count9 int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "inStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buf_r", "interface" : "fifo", "bitwidth" : 65, "direction" : "WRITEONLY"} , 
 	{ "Name" : "count9", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buf_r_din sc_out sc_lv 65 signal 4 } 
	{ buf_r_num_data_valid sc_in sc_lv 13 signal 4 } 
	{ buf_r_fifo_cap sc_in sc_lv 13 signal 4 } 
	{ buf_r_full_n sc_in sc_logic 1 signal 4 } 
	{ buf_r_write sc_out sc_logic 1 signal 4 } 
	{ count9_din sc_out sc_lv 32 signal 5 } 
	{ count9_num_data_valid sc_in sc_lv 7 signal 5 } 
	{ count9_fifo_cap sc_in sc_lv 7 signal 5 } 
	{ count9_full_n sc_in sc_logic 1 signal 5 } 
	{ count9_write sc_out sc_logic 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_r_din", "direction": "out", "datatype": "sc_lv", "bitwidth":65, "type": "signal", "bundle":{"name": "buf_r", "role": "din" }} , 
 	...
 	{ "name": "count9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "count9", "role": "din" }} , 
 	...
 	{ "name": "count9_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count9", "role": "full_n" }} , 
 	{ "name": "count9_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count9", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "count9", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	buf_r { ap_fifo {  { buf_r_din fifo_port_we 1 65 }  { buf_r_num_data_valid fifo_status_num_data_valid 0 13 }  { buf_r_fifo_cap fifo_update 0 13 }  { buf_r_full_n fifo_status 0 1 }  { buf_r_write fifo_data 1 1 } } }
	count9 { ap_fifo {  { count9_din fifo_port_we 1 32 }  { count9_num_data_valid fifo_status_num_data_valid 0 7 }  { count9_fifo_cap fifo_update 0 7 }  { count9_full_n fifo_status 0 1 }  { count9_write fifo_data 1 1 } } }
}
