...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TKEEP { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TSTRB { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_buf_r \
    op interface \
    ports { buf_r_din { O 65 vector } buf_r_num_data_valid { I 13 vector } buf_r_fifo_cap { I 13 vector } buf_r_full_n { I 1 bit } buf_r_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_count9 \
    op interface \
    ports { count9_din { O 32 vector } count9_num_data_valid { I 7 vector } count9_fifo_cap { I 7 vector } count9_full_n { I 1 bit } count9_write { O 1 bit } } \
} "
}
