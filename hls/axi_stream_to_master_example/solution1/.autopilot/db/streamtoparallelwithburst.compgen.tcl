...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_buf_r \
    op interface \
    ports { buf_r_dout { I 65 vector } buf_r_num_data_valid { I 13 vector } buf_r_fifo_cap { I 13 vector } buf_r_empty_n { I 1 bit } buf_r_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_count9 \
    op interface \
    ports { count9_dout { I 32 vector } count9_num_data_valid { I 7 vector } count9_fifo_cap { I 7 vector } count9_empty_n { I 1 bit } count9_read { O 1 bit } } \
} "
}
