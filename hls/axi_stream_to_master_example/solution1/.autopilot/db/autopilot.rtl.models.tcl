set SynModuleInfo {
  ...
  {SRCNAME example MODELNAME example RTLNAME example IS_TOP 1
    SUBMODULES {
      {MODELNAME example_fifo_w64_d3_S RTLNAME example_fifo_w64_d3_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME example_fifo_w65_d4096_A RTLNAME example_fifo_w65_d4096_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME example_fifo_w32_d64_A RTLNAME example_fifo_w32_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME example_start_for_streamtoparallelwithburst_U0 RTLNAME example_start_for_streamtoparallelwithburst_U0 BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME example_gmem0_m_axi RTLNAME example_gmem0_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
