...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStreamTop_TDATA", 64, hls_in, 1, "axis", "in_data", 1),
	Port_Property("inStreamTop_TKEEP", 8, hls_in, 2, "axis", "in_data", 1),
	Port_Property("inStreamTop_TSTRB", 8, hls_in, 3, "axis", "in_data", 1),
	Port_Property("inStreamTop_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("inStreamTop_TVALID", 1, hls_in, 4, "axis", "in_vld", 1),
	Port_Property("inStreamTop_TREADY", 1, hls_out, 4, "axis", "in_acc", 1),
};
