...
set C_modelArgList {
	...
	{ outTop int 64 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "outTop","offset": { "type": "dynamic","port_name": "outTop","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "outTop", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} ]}
...
set portList { 
	...
	{ inStreamTop_TDATA sc_in sc_lv 64 signal 1 } 
	{ inStreamTop_TKEEP sc_in sc_lv 8 signal 2 } 
	{ inStreamTop_TSTRB sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"example","role":"start","value":"0","valid_bit":"0"},{"name":"example","role":"continue","value":"0","valid_bit":"4"},{"name":"example","role":"auto_start","value":"0","valid_bit":"7"},{"name":"outTop","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"example","role":"start","value":"0","valid_bit":"0"},{"name":"example","role":"done","value":"0","valid_bit":"1"},{"name":"example","role":"idle","value":"0","valid_bit":"2"},{"name":"example","role":"ready","value":"0","valid_bit":"3"},{"name":"example","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "10", "13", "14", "15", "16"],
		"CDFG" : "example",
		"Protocol" : "ap_ctrl_hs",
		...
		"InputProcess" : [
			...
			{"ID" : "4", "Name" : "getinstream_U0"}],
		"OutputProcess" : [
			{"ID" : "10", "Name" : "streamtoparallelwithburst_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "streamtoparallelwithburst_U0", "Port" : "gmem0"}]},
			{"Name" : "inStreamTop_V_data_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "getinstream_U0", "Port" : "inStreamTop_V_data_V"}]},
			{"Name" : "inStreamTop_V_keep_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "getinstream_U0", "Port" : "inStreamTop_V_keep_V"}]},
			{"Name" : "inStreamTop_V_strb_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "getinstream_U0", "Port" : "inStreamTop_V_strb_V"}]},
			{"Name" : "inStreamTop_V_last_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "getinstream_U0", "Port" : "inStreamTop_V_last_V"}]},
			{"Name" : "outTop", "Type" : "None", "Direction" : "I"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "outTop", "Type" : "None", "Direction" : "I"},
			{"Name" : "outTop_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "13", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "outTop_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.getinstream_U0", "Parent" : "0", "Child" : ["5", "6", "7", "8", "9"],
		"CDFG" : "getinstream",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "inStreamTop_V_strb_V", "Type" : "Axis", "Direction" : "I"},
			{"Name" : "inStreamTop_V_last_V", "Type" : "Axis", "Direction" : "I"},
			{"Name" : "buf_r", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "14", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "buf_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "count9", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "15", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "count9_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_38_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.getinstream_U0.flow_control_loop_pipe_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.getinstream_U0.regslice_both_inStreamTop_V_data_V_U", "Parent" : "4"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.getinstream_U0.regslice_both_inStreamTop_V_keep_V_U", "Parent" : "4"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.getinstream_U0.regslice_both_inStreamTop_V_strb_V_U", "Parent" : "4"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.getinstream_U0.regslice_both_inStreamTop_V_last_V_U", "Parent" : "4"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.streamtoparallelwithburst_U0", "Parent" : "0", "Child" : ["11"],
		...
		"Port" : [
			{"Name" : "buf_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "14", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Port" : "buf_r", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "count9", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "15", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "count9_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
				...
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Port" : "gmem0", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "out_memory", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "13", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Parent" : "10", "Child" : ["12"],
		...
		"Port" : [
			...
			{"Name" : "buf_r", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "buf_r_blk_n", "Type" : "RtlSignal"}]},
	...
	{"ID" : "12", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105.flow_control_loop_pipe_sequential_init_U", "Parent" : "11"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.outTop_c_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buf_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.count_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_streamtoparallelwithburst_U0_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	example {
		...
		outTop {Type I LastRead 2 FirstWrite -1}}
	entry_proc {
		outTop {Type I LastRead 0 FirstWrite -1}
		outTop_c {Type O LastRead -1 FirstWrite 0}}
	getinstream {
		inStreamTop_V_data_V {Type I LastRead 0 FirstWrite -1}
		inStreamTop_V_keep_V {Type I LastRead 0 FirstWrite -1}
		inStreamTop_V_strb_V {Type I LastRead 0 FirstWrite -1}
		...
		count9 {Type O LastRead -1 FirstWrite 1}}
	streamtoparallelwithburst {
		buf_r {Type I LastRead 1 FirstWrite -1}
		count9 {Type I LastRead 1 FirstWrite -1}
		gmem0 {Type O LastRead 5 FirstWrite 2}
