...
__attribute__((sdx_kernel("example", 0))) void example(hls::stream<trans_pkt >& inStreamTop,
...
__attribute__((sdx_kernel("example", 0))) void example(hls::stream<trans_pkt >& inStreamTop, ap_uint<64> outTop[1024] ) {
#line 15 "E:/estimation_accel/hls/axi_stream_to_master_example/solution1/csynth.tcl"
