...
auto* sinStreamTop_V_data_V = bcsim::createStream((hls::stream<long long>*)__xlx_apatb_param_inStreamTop_V_data_V);
...
auto* sinStreamTop_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_inStreamTop_V_last_V);
  // DUT call
  example(__xlx_outTop__input_buffer, sinStreamTop_V_data_V->data<long long>(), sinStreamTop_V_keep_V->data<char>(), sinStreamTop_V_strb_V->data<char>(), sinStreamTop_V_last_V->data<char>(), __xlx_offset_byte_param_outTop);
...
sinStreamTop_V_data_V->transfer((hls::stream<long long>*)__xlx_apatb_param_inStreamTop_V_data_V);
