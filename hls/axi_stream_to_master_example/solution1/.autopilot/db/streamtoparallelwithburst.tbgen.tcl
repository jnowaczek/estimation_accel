...
set C_modelArgList {
	{ buf_r int 65 regular {fifo 0 volatile }  }
	{ count9 int 32 regular {fifo 0 volatile }  }
	{ gmem0 int 64 regular {axi_master 1}  }
	{ out_memory int 64 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "buf_r", "interface" : "fifo", "bitwidth" : 65, "direction" : "READONLY"} , 
 	{ "Name" : "count9", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buf_r_dout sc_in sc_lv 65 signal 0 } 
	{ buf_r_num_data_valid sc_in sc_lv 13 signal 0 } 
	{ buf_r_fifo_cap sc_in sc_lv 13 signal 0 } 
	{ buf_r_empty_n sc_in sc_logic 1 signal 0 } 
	{ buf_r_read sc_out sc_logic 1 signal 0 } 
	{ count9_dout sc_in sc_lv 32 signal 1 } 
	{ count9_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ count9_fifo_cap sc_in sc_lv 7 signal 1 } 
	{ count9_empty_n sc_in sc_logic 1 signal 1 } 
	{ count9_read sc_out sc_logic 1 signal 1 } 
	...
	{ out_memory_dout sc_in sc_lv 64 signal 3 } 
	{ out_memory_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ out_memory_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ out_memory_empty_n sc_in sc_logic 1 signal 3 } 
	{ out_memory_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_r_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":65, "type": "signal", "bundle":{"name": "buf_r", "role": "dout" }} , 
 	{ "name": "buf_r_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "buf_r", "role": "num_data_valid" }} , 
 	{ "name": "buf_r_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "buf_r", "role": "fifo_cap" }} , 
 	{ "name": "buf_r_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_r", "role": "empty_n" }} , 
 	{ "name": "buf_r_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_r", "role": "read" }} , 
 	{ "name": "count9_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "count9", "role": "dout" }} , 
 	{ "name": "count9_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "count9", "role": "num_data_valid" }} , 
 	{ "name": "count9_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "count9", "role": "fifo_cap" }} , 
 	{ "name": "count9_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count9", "role": "empty_n" }} , 
 	{ "name": "count9_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "count9", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "buf_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4096", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Port" : "buf_r", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "count9", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Port" : "gmem0", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_24_2_fu_105.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	buf_r { ap_fifo {  { buf_r_dout fifo_port_we 0 65 }  { buf_r_num_data_valid fifo_status_num_data_valid 0 13 }  { buf_r_fifo_cap fifo_update 0 13 }  { buf_r_empty_n fifo_status 0 1 }  { buf_r_read fifo_data 1 1 } } }
	count9 { ap_fifo {  { count9_dout fifo_port_we 0 32 }  { count9_num_data_valid fifo_status_num_data_valid 0 7 }  { count9_fifo_cap fifo_update 0 7 }  { count9_empty_n fifo_status 0 1 }  { count9_read fifo_data 1 1 } } }
