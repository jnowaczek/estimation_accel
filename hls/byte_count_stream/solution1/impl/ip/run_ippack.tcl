...
## IP Info
set Vendor      "jnowaczek"
set Library     "byte_count_stream"
set IPName      "accelerator"
set Version     "1.0"
set DisplayName "Byte Count Stream"
set Revision    "6"
...
set xo_kernel_name "accelerator"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "E:/estimation_accel/hls/byte_count_stream/solution1"
set debug_dir "E:/estimation_accel/hls/byte_count_stream/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {accelerator_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 num_blocks W 0x0 "Data signal of num_blocks" {{0 32 num_blocks W 0 "Bit 31 to 0 of num_blocks"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_ctrl {
        type "ap_ctrl"
        ctrl_ports "ap_start ap_done ap_ready ap_idle ap_continue"
        ctype {
            start {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 9.359 machine 64 combinational 0 latency undef II x}
