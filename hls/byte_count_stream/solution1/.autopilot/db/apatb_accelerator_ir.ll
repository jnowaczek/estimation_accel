...
entry:
  ...
  %Out_copy = alloca %"class.hls::stream<int, 0>", align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(%"class.hls::stream<int, 0>"* %Out_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<unsigned char, 0>"* nonnull %In, %"class.hls::stream<unsigned char, 0>"* nonnull align 512 %In_copy, %"class.hls::stream<int, 0>"* nonnull %Out, %"class.hls::stream<int, 0>"* nonnull align 512 %Out_copy)
  call void @apatb_accelerator_hw(%"class.hls::stream<unsigned char, 0>"* %In_copy, i32 %num_blocks, %"class.hls::stream<int, 0>"* %Out_copy)
  call void @copy_back(%"class.hls::stream<unsigned char, 0>"* %In, %"class.hls::stream<unsigned char, 0>"* %In_copy, %"class.hls::stream<int, 0>"* %Out, %"class.hls::stream<int, 0>"* %Out_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<unsigned char, 0>"* noalias, %"class.hls::stream<unsigned char, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<unsigned char, 0>"* noalias, %"class.hls::stream<unsigned char, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_accelerator_hw(%"class.hls::stream<unsigned char, 0>"*, i32, %"class.hls::stream<int, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<unsigned char, 0>"* noalias, %"class.hls::stream<unsigned char, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<int, 0>"* noalias, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<unsigned char, 0>"(%"class.hls::stream<unsigned char, 0>"* %0, %"class.hls::stream<unsigned char, 0>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>"(%"class.hls::stream<int, 0>"* %2, %"class.hls::stream<int, 0>"* align 512 %3)
  ret void
...
define void @accelerator_hw_stub_wrapper(%"class.hls::stream<unsigned char, 0>"*, i32, %"class.hls::stream<int, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<unsigned char, 0>"* null, %"class.hls::stream<unsigned char, 0>"* %0, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  call void @accelerator_hw_stub(%"class.hls::stream<unsigned char, 0>"* %0, i32 %1, %"class.hls::stream<int, 0>"* %2)
  call void @copy_in(%"class.hls::stream<unsigned char, 0>"* null, %"class.hls::stream<unsigned char, 0>"* %0, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  ret void
}
