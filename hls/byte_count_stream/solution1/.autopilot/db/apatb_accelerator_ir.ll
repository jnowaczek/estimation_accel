...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<unsigned char, 0>.24"(i8* align 512 %1, %"class.hls::stream<unsigned char, 0>"* %0)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.12"(%"class.hls::stream<int, 0>"* %2, i32* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<int, 0>.12"(%"class.hls::stream<int, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i32* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.15"(%"class.hls::stream<int, 0>"* nonnull %0, i32* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<int, 0>.15"(%"class.hls::stream<int, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i32* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i32
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<unsigned char, 0>.24"(i8* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<unsigned char, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %2 = icmp eq i8* %0, null
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<unsigned char, 0>.27"(i8* nonnull align 512 %0, %"class.hls::stream<unsigned char, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<unsigned char, 0>.27"(i8* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<unsigned char, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
