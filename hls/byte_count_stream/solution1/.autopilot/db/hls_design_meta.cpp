...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("Out_r_TUSER", 1, hls_out, 4, "axis", "out_data", 1),
	Port_Property("Out_r_TLAST", 1, hls_out, 5, "axis", "out_data", 1),
	Port_Property("Out_r_TID", 1, hls_out, 6, "axis", "out_data", 1),
	Port_Property("Out_r_TDEST", 1, hls_out, 7, "axis", "out_data", 1),
