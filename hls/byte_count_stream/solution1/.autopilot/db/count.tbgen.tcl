...
set C_modelArgList {
	...
	{ appear int 8 regular {array 256 { 0 2 } 1 1 }  }
}
...
set portList { 
	...
	{ appear_d1 sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "appear_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "appear", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	...
	appear { ap_memory {  { appear_address0 mem_address 1 8 }  { appear_ce0 mem_ce 1 1 }  { appear_we0 mem_we 1 1 }  { appear_d0 mem_din 1 8 }  { appear_address1 MemPortADDR2 1 8 }  { appear_ce1 MemPortCE2 1 1 }  { appear_we1 MemPortWE2 1 1 }  { appear_d1 MemPortDIN2 1 8 }  { appear_q1 MemPortDOUT2 0 8 } } }
}
