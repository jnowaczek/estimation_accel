...
#ifndef _accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_H_
#define _accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(accelerator_input_blocks_buf_data_RAM_AUTO_1R1W) {
...
protected:
    ...
    accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore* accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U;
...
public:
    ...
    SC_CTOR(accelerator_input_blocks_buf_data_RAM_AUTO_1R1W) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U = new accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore("accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U");
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->clk      ( clk );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->reset    ( reset );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->ce0      ( i_ce0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->we0      ( i_we0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->address0 ( memcore_iaddr );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->d0       ( i_d0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->q0       ( i_q0 );

        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->ce1      ( t_ce0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->we1      ( t_we0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->address1 ( memcore_taddr );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->d1       ( t_d0 );
        accelerator_input_blocks_buf_data_RAM_AUTO_1R1W_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "accelerator_input_blocks_buf_data_RAM_AUTO_1R1W.trace");
            // ports
