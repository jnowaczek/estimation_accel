...
#ifndef _accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_H_
#define _accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W) {
...
protected:
    ...
    // buffer instances
    accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore* buffer[BufferCount];
...
public:
    ~accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W();
    SC_CTOR(accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W) : m_trace_file(0) {
        for (unsigned i = 0; i < BufferCount; i++) {
            char szTmp[128];
            sprintf(szTmp, "%d", i);
            std::string name = "accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore_U_";
            name += szTmp;

            buffer[i] = new accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W_memcore(name.c_str());
            buffer[i]->clk      ( clk );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "accelerator_dataflow_in_loop_VITIS_LOOP_13_1_appear_V_RAM_AUTO_1R1W.trace");
            // ports
