...
auto* sOut_r = bcsim::createStream((hls::stream<int>*)__xlx_apatb_param_Out_r);
  // DUT call
  accelerator(sIn_r->data<int>(), sOut_r->data<int>());
sIn_r->transfer((hls::stream<int>*)__xlx_apatb_param_In_r);
