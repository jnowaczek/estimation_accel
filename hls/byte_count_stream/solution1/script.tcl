...
config_export -display_name {Byte Count Stream} -format ip_catalog -library byte_count_stream -output E:/estimation_accel/vivado/ip_repo/ -rtl verilog -vendor jnowaczek -version 1.0.6
