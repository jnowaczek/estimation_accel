...
architecture behav of accelerator_count1 is 
...
attribute shreg_extract : string;
    ...
    signal grp_count1_Pipeline_APPEARANCES_fu_99_ap_start : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_ap_done : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_ap_idle : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_ap_ready : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_in_r_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_count1_Pipeline_APPEARANCES_fu_99_in_r_ce0 : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_in_r_read : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_p_out : STD_LOGIC_VECTOR (2047 downto 0);
    signal grp_count1_Pipeline_APPEARANCES_fu_99_p_out_ap_vld : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_prev_02_out : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_count1_Pipeline_APPEARANCES_fu_99_prev_02_out_ap_vld : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_count_01_out : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_count1_Pipeline_APPEARANCES_fu_99_count_01_out_ap_vld : STD_LOGIC;
    signal grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg : STD_LOGIC := '0';
    ...
    component accelerator_count1_Pipeline_APPEARANCES IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_count1_Pipeline_APPEARANCES_fu_99 : component accelerator_count1_Pipeline_APPEARANCES
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                    grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_count1_Pipeline_APPEARANCES_fu_99_ap_ready = ap_const_logic_1)) then 
                    grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, in_r_empty_n, grp_count1_Pipeline_APPEARANCES_fu_99_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state5, out_r_full_n, ap_CS_fsm_state6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_count1_Pipeline_APPEARANCES_fu_99_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_count1_Pipeline_APPEARANCES_fu_99_ap_done)
    begin
        if ((grp_count1_Pipeline_APPEARANCES_fu_99_ap_done = ap_const_logic_0)) then 
    ...
    grp_count1_Pipeline_APPEARANCES_fu_99_ap_start <= grp_count1_Pipeline_APPEARANCES_fu_99_ap_start_reg;

    in_r_address0_assign_proc : process(ap_CS_fsm_state1, grp_count1_Pipeline_APPEARANCES_fu_99_in_r_address0, ap_CS_fsm_state4)
    begin
    ...
    in_r_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_r_empty_n, grp_count1_Pipeline_APPEARANCES_fu_99_in_r_ce0, ap_CS_fsm_state4)
    begin
        if ((not(((in_r_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    in_r_read_assign_proc : process(grp_count1_Pipeline_APPEARANCES_fu_99_in_r_read, ap_CS_fsm_state3, ap_CS_fsm_state4, out_r_full_n, ap_CS_fsm_state6)
    begin
        if (((out_r_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
