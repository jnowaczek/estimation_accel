...
$(ObjDir)/byte_count_stream_bench.cpp_pre.cpp.tb.o : byte_count_stream_bench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling byte_count_stream_bench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/byte_count_stream.cpp_pre.cpp.tb.o : byte_count_stream.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling byte_count_stream.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
