...
`define AUTOTB_TVIN_In_r_out_wrapc  "../tv/rtldatafile/rtl.accelerator.autotvin_In_r.dat"
`define AUTOTB_TVIN_num_blocks_out_wrapc  "../tv/rtldatafile/rtl.accelerator.autotvin_num_blocks.dat"
`define AUTOTB_TVOUT_Out_r  "../tv/cdatafile/c.accelerator.autotvout_Out_r.dat"
`define AUTOTB_TVOUT_Out_r_out_wrapc  "../tv/rtldatafile/rtl.accelerator.autotvout_Out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 14;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_In_r = 1029120;
parameter LENGTH_num_blocks = 1;
parameter LENGTH_Out_r = 1005;
...
// The signal of port num_blocks
reg [31: 0] AESL_REG_num_blocks = 0;
assign num_blocks = AESL_REG_num_blocks;
initial begin : read_file_process_num_blocks
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_num_blocks,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_num_blocks);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_num_blocks);
              if (ret != 1) begin
...
reg end_num_blocks;
reg [31:0] size_num_blocks;
reg [31:0] size_num_blocks_backup;
reg end_Out_r;
reg [31:0] size_Out_r;
...
// Dependence Check (RAW) "ap_enable_operation_31"(W:SV2-2) -> "ap_enable_operation_34"(R:SV2-3) @ `AUTOTB_DUT_INST.dataflow_in_loop_VITIS_LOOP_10_1_U0.count_U0.grp_count_Pipeline_APPEARANCES_fu_2861
