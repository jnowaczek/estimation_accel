...
$(ObjDir)/byte_count_bench.c++_pre.c++.tb.o : byte_count_bench.c++_pre.c++.tb.c++ $(ObjDir)/.dir
	$(Echo) "   Compiling byte_count_bench.c++_pre.c++.tb.c++" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/byte_count.c++_pre.c++.tb.o : byte_count.c++_pre.c++.tb.c++ $(ObjDir)/.dir
	$(Echo) "   Compiling byte_count.c++_pre.c++.tb.c++" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
