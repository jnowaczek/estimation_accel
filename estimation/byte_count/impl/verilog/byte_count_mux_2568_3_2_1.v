...
module byte_count_mux_2568_3_2_1 #(
parameter
    ID                = 0,
    NUM_STAGE         = 1,
    din0_WIDTH       = 32,
...
reg  [2 : 0]         mux_4_8_reg;
reg  [2 : 0]         mux_4_9_reg;
reg  [2 : 0]         mux_4_10_reg;
reg  [2 : 0]         mux_4_11_reg;
reg  [2 : 0]         mux_4_12_reg;
reg  [2 : 0]         mux_4_13_reg;
reg  [2 : 0]         mux_4_14_reg;
reg  [2 : 0]         mux_4_15_reg;
reg  [7 : 4]      sel4;
// level 5 signals
wire [2 : 0]         mux_5_0;
wire [2 : 0]         mux_5_1;
